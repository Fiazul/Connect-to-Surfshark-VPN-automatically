echo "Installing Surfshark Wireguard CLI..."

# Create the CLI script
sudo cat > /usr/local/bin/wg-cli << 'EOF'
"""
...
# Make it executable
sudo chmod +x /usr/local/bin/wireguard-cli

echo "Surfshark Wireguard CLI installed successfully!"
echo ""
echo "Usage:"
echo "  wg-cli setup      # Initial setup"
echo "  wg-cli connect    # Connect to random server"
echo "  wg-cli disconnect # Disconnect"
echo "  wg-cli status     # Check status"
echo ""
echo "First run: wg-cli setup"